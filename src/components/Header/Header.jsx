  ...
  return (
    <header className='z-30 fixed top-0 w-full min-h-[3rem] md:h-[5rem] shadow px-6 py-2 bg-gray-500'>
        ...
        <nav className='flex md:hidden w-full justify-between items-center'>
          ...
          <div onClick={()=> setNav((prev) => !prev)} className='menu hover:scale-105 transition-all cursor-pointer flex justify-center items-center w-[2rem] h-[2rem]'>
            <img src={menu} className='w-full h-full object-cover'/>
          </div>
          <ul className={`flex flex-col z-10 transition-transform duration-300 ease-in-out transform ${
